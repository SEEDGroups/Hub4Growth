...
<div id="testimonial_text_wap" class="col-xs-9 col-sm-10">
      <div class="testimonial_text">
        <div class="col-sm-3">
            <img src="<?php echo IMAGE_URL; ?>Rabindra.jpg" class="img-responsive" alt="Director" />
        </div>
        <div class="col-sm-9">
    ...
    <div class="testimonial_text">
        <div class="col-sm-3">
            <img src="<?php echo IMAGE_URL; ?>mahendra.jpg" class="img-responsive" alt="Deputy Director" />
        </div>
        <div class="col-sm-9">
    ...
    <div class="testimonial_text">
        <div class="col-sm-3">
            <img src="<?php echo IMAGE_URL; ?>mandip.jpg" class="img-responsive" alt="Associate Researcher" />
        </div>
        <div class="col-sm-9">
            <h2>Mandip Kumar Thakur</h2>
    ...
    <div class="testimonial_text">
        <div class="col-sm-3">
            <img src="<?php echo IMAGE_URL; ?>binod.jpg" class="img-responsive" alt="Chief Executive Officer" />
        </div>
        <div class="col-sm-9">
    ...
    <div class="testimonial_text">
        <div class="col-sm-3">
            <img src="<?php echo IMAGE_URL; ?>templatemo_member_03.jpg" class="img-responsive" alt="Associate Researcher" />
        </div>
        <div class="col-sm-9">
