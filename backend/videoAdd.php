                ...
                <div class="row">
                        <form class="form-horizontal" method="POST" action="<?php echo (isset($act) && $act=='update')? 'inc/videoLinkUpdate' : 'inc/videoLinkProcess'; ?>">
                            ...
                            <div class="col-sm-6">
                              ...
                              <?php if($videoInfo['id']){
                                ?>
                                <input type="hidden" name="id" id="id" value="<?php echo $videoInfo['id']; ?>">
                                <?php
                              } ?>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                             <input type="text" name="videoId" id="videoId" class="form-control" required placeholder="http://youtube.com...." value="<?php echo (isset($videoInfo))? 'https://www.youtube.com/watch?v='.$videoInfo['videoId'] : ''; ?>">
                            </div>
                          </div>
													<div class="form-group">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="3" style="resize:vertical;">
                              <?php echo (isset($videoInfo['description']))? html_entity_decode(stripslashes($videoInfo['description'])) : ''; ?>
                                </textarea>
                            </div>
                          </div>
                          <div class="form-group">
